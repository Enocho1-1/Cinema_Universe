      ...
      <div className="inputFieldContain max-h-[600px] w-[500px] max-md:w-[350px] min-2xl:mt-[120px]">
        ...
        <form onSubmit={handleRegister} className="py-2">
          <div className="mb-2">
            ...
            <button  className="flex justify-center px-6 py-2 mt-3 ml-2 font-medium text-white  bg-primary-blue hover:bg-secondary-blue font-teko rounded-lg w-full"type="submit">
