    ...
    <main className="relative overflow-x-hidden h-screen w-screen bg-primary-black" >
      ...
      <section className=" max-w-7xl m-auto mt-[100px]">
        <header className="movieList p-4">
          <h1 className="font-bold text-4xl text-gray-300 flex justify-start ml-6 max-tablet:justify-center"><img src={play} className="h-8 self-center mr-2"/>{title} · {page}</h1>
        </header>
