    ...
    <main className="initial h-screen w-screen">
        ...
        <section className="relative z-10 mt-[175px] max-md:mt-[100px] flex flex-col items-center justify-center max-md:text-center">
          ...
          <>
            ...
            <form className="mt-4 flex items-center max-[600px]:flex-col">   
                <div className="relative w-full">
                    <input type="email" id="voice-search" className="initialInput border border-gray-300 text-white text-sm rounded-lg block pl-10 py-3 px-48" placeholder="Email Address" required/>
                </div>
                <div className="w-full max-md:w-[50%] max-md:mt-4">
                  <Link to={"/register"} type="submit" className="flex items-center px-6 py-2 ml-2 font-medium text-white bg-primary hover:bg-red-800 font-teko rounded-lg">
