    ...
    <div className=" CarouselContain">
        <Carousel className="m-0 p-0 ">
            ...
            <figure className="relative w-full">
                ...
                <figcaption className="carouselCaption font-sans flex flex-col">
                    <h1 className="font-semibold text-gray-200 text-6xl max-lg:text-4xl ">Movie Title</h1>

                    
                    <aside className="text-md mt-4 max-w-6xl flex ">
                        ...
                        <span className=" max-w-xl ml-2 flex items-center">
                            <img src={star} className="h-[5px] w-2" alt="" />
