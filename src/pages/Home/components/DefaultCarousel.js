  ...
  return (
    <div className=" CarouselContain">
        <Carousel>
            {/* Slide 1 */}
            <figure>
                <img  className="mainImg" src="https://www.slashfilm.com/img/gallery/al-pacino-was-almost-fired-two-weeks-into-filming-the-godfather/l-intro-1670452428.jpg" alt="..."/>
                <figcaption className="carouselCaption font-sans ">
                    <h1 className="font-semibold text-gray-200 text-6xl max-lg:text-3xl ">Movie Title</h1>
                    <aside className="text-md mt-4 max-w-6xl flex max-tablet:justify-center">
                        ...
                        <>
                            ...
                            <p className="ml-2 text-sm text-gray-200">9.5/10</p>
                        </>
            ...
            <figure className=" relative  w-full">
                <img  className="mainImg" src="https://raisingworldchildren.com/wp-content/uploads/2018/11/the-pursuit-of-happyness.jpg" alt="..."/>
                <figcaption className="carouselCaption font-sans    ">
                    <h1 className="font-semibold text-gray-200 text-6xl max-lg:text-3xl  ">Movie Title</h1>
            ...
            <figure className=" relative w-full">
                <img  className="mainImg" src="https://m.media-amazon.com/images/M/MV5BMTgyMDUzMDYxNl5BMl5BanBnXkFtZTcwMzAzNDQyNw@@._V1_.jpg" alt="..."/>
                <figcaption className="carouselCaption font-sans   ">
                    <h1 className="font-semibold text-gray-200 text-6xl max-lg:text-3xl ">Movie Title</h1>
                    {/* <aside className="text-md mt-4 max-w-4xl flex ">
                        <span className="font-semibold text-sm px-2 rounded-lg bg-primary-blue">HD</span>
            ...
            <figure className=" relative  w-full">
                <img  className="mainImg" src="https://a.ltrbxd.com/resized/sm/upload/ho/gl/t1/5p/ex%20machina-1200-1200-675-675-crop-000000.jpg?v=ae03cd4b51" alt="..."/>
                <figcaption className="carouselCaption font-sans   ">
                    <h1 className="font-semibold text-gray-200 text-6xl max-lg:text-3xl ">Movie Title</h1>
                    {/* <aside className="text-md mt-4 max-w-4xl flex ">
                        <span className="font-semibold text-sm px-2 rounded-lg bg-primary-blue">HD</span>
            ...
            <figure className=" relative  w-full">
                <img  className="mainImg" src="https://m.media-amazon.com/images/S/pv-target-images/86dfd3549f93ed320fa617005385b59dbcb9fa801fc78cf4752c479a0a1e936c.jpg" alt="..."/>
                <figcaption className="carouselCaption font-sans   ">
                    <h1 className="font-semibold text-gray-200 text-6xl max-lg:text-3xl ">Movie Title</h1>
                    {/* <aside className="text-md mt-4 max-w-4xl flex ">
                        <span className="font-semibold text-sm px-2 rounded-lg bg-primary-blue">HD</span>
