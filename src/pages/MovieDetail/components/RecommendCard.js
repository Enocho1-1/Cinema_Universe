...
export const RecommendCard = ({item,type}) => {
  ...
  return (
    <>
            <Link to={`/${id}`} onClick={() => saveType(type)} className="flex max-w-[300px] rounded-lg mt-2 mx-2 bg-gray-900 hover:cursor-pointer hover:bg-gray-600">
                <img src={posterImage ? posterImage : collage} className="h-[100px]" alt="" />
