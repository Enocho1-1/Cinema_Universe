    ...
    <>
        { list.length === 0 ? "" : (
                    <div className=" flex flex-col  max-lg:my-8 ">
                      ...
                      <aside className="mt-4 flex flex-col h-[370px] w-auto overflow-y-scroll max-lg:h-fit max-lg:grid max-mobile:grid-cols-twoCols mobile:max-mobileLg:grid-cols-threeCols mobileLg:max-lg:grid-cols-fiveCols max-lg:overflow-y-hidden max-lg:gap-y-4  ">
                        { list.map( (item,index )=> (
